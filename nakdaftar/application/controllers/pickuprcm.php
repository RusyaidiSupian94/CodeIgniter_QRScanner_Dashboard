...
class Pickuprcm extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('pickup/pickuprcm/pickuprcm');
	...
	public function validation(){
		...
		$login = $this->pickup_model->can_loginrcm($no_siri);
		$hadir = $this->pickup_model->checkhadirandesitrcm($no_siri);
		...
		if($login)
		{
			...
			$data['kehadiran'] = '1';
			$query = $this->pickup_model->hadirrcm($data,$no_siri);
			redirect('pickuprcm/success');///update kehadiran
		}
		else if ($hadir){
	...
	public function success(){
		$this->load->view('pickup/headerpickup');
		$this->load->view('pickup/pickuprcm/successrcm');
		$this->load->view('pickup/footerpickup');
	}
}