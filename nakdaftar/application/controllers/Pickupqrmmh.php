...
class Pickupqrmmh extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('qrpickup/qrpickupmmh/pickupmmh');
		$this->load->view('qrpickup/qrpickupmmh/footerpickup');
	}
	...
	public function validation(){
		...
		$login = $this->pickup_model->can_loginmmh($code);
		$hadir = $this->pickup_model->checkhadirandesitmmh($code);
		...
		if($login)
		{
			...
			//$code=$this->input->post('code');
			$data['kehadiran'] = '1';
			$query = $this->pickup_model->hadirmmh($data,$code);
...
// 			echo "<script type='text/javascript'>alert('$message');window.location = ('success') </script>";
	...
	public function success(){
		$this->load->view('qrpickup/headerpickup');
		$this->load->view('qrpickup/qrpickupmmh/successpage');
		$this->load->view('qrpickup/qrpickupmmh/footerpickup');
	}
}
