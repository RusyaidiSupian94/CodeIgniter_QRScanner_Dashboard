...
class Pickupqrmmf extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('qrpickup/qrpickupmmf/pickupmmf');
		$this->load->view('qrpickup/qrpickupmmf/footerpickup');
	}
	...
	public function validation(){
		...
		$login = $this->pickup_model->can_loginmmf($code);
		$hadir = $this->pickup_model->checkhadirandesitmmf($code);
		...
		if($login)
		{
			...
			//$code=$this->input->post('code');
			$data['kehadiran'] = '1';
			$query = $this->pickup_model->hadirmmf($data,$code);
...
// 			echo "<script type='text/javascript'>alert('$message');window.location = ('success') </script>";
	...
	public function success(){
		$this->load->view('qrpickup/headerpickup');
		$this->load->view('qrpickup/qrpickupmmf/successpage');
		$this->load->view('qrpickup/qrpickupmmf/footerpickup');
	}
}
