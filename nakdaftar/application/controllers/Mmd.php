...
class Mmd extends CI_Controller {
	...
	{	
		...
		$this->load->view('mmd/header', $data);
		$this->load->view('mmd/login');
		$this->load->view('mmd/footer');
	}
	...
	public function login_validation()
	{
		...
		$login = $this->mmd_model->can_login($nric);
	...
	// {
	// 	$data['userdata'] = $this->mmd_model->fetch_userdata($this->session->userdata('nric'));
	// 	$data['title'] = 'Nak Daftar | Aplikasi Pendaftaran';

	// 	if($this->session->userdata('nric') != '')
	// 	{
	// 		$this->load->view('mmd/header', $data);
	// 		$this->load->view('mmd/profile', $data);
	// 		$this->load->view('mmd/footer');
	// 	}
	...
	// 	$data['title'] = 'Nak Daftar | Aplikasi Pendaftaran';
	// 	$data['userdata'] = $this->mmd_model->fetch_userdata($this->session->userdata('nric'));
	// 	$data['user_data'] = $this->mmd_model->fetch_single_data($this->session->userdata('nric'));

	// 	if($this->session->userdata('nric') != '')
	// 	{
	// 	$this->load->view('mmd/header', $data);
	// 	$this->load->view('mmd/survey', $data);
	// 	$this->load->view('mmd/footer');
	// 	}
	...
	// 	{
	// 	$this->load->view('mmd/header', $data);
	// 	$this->load->view('mmd/survey_prefil', $data);
	// 	$this->load->view('mmd/footer');
	// 	}
	...
	// 		if($this->mmd_model->update_userdata($data,$nric))
	// 		{

	// 			$this->mmd_model->update_userdata($data, $this->input->post('hidden_id'));
	// 			$data['userdata'] = $this->mmd_model->fetch_userdata($this->session->userdata('nric'));
	// 			//$enter = $this->mmd_model->fetch_userdata($this->session->userdata('nric'));
	// 			$data['user_data'] = $this->mmd_model->fetch_single_data($this->session->userdata('nric'));

	// 			$data["fetch_data"] = $this->mmd_model->fetch_data();
	...
	// 			$this->load->view('mmd/header', $data);
	// 			$this->load->view('mmd/pengesahan', $data);
	// 			$this->load->view('mmd/footer');
	// 			//redirect(base_url() . 'mmd/generateQR');
	// 		}
	...
	// 	{
	// 		//false
	// 		redirect(base_url() . 'mmd/peserta_survey');
	// 	}
	// }
