<section id="subscribe" class="bg-parallax pt100 pb100" data-jarallax='{"speed": 0.2}' style='min-height:100%; background-image: url("<?php echo base_url()?>assets/images/bg-smf2.jpg")'>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            ...
                            <h2 style="margin-bottom:0px; color:#ffffff; font-weight:500" class="mb30">SEMINAR MY FINANCE</h2>
                            ...
                            <form action="<?php echo base_url()?>smf/peserta_survey_pengesahan" method="POST">
