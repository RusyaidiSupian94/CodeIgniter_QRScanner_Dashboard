                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            ...
                            <h2 style="margin-bottom:0px; color:#ffffff; font-weight:500" class="mb30">BILANGAN PESERTA<br>MASTERY MY DOCUMENTS<br><!-- KINI DIBUKA --></h2>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                 	<div class="col-md5 text-center">
                                    	<a href="<?php echo base_url(); ?>pickupqrmmd/index" class='text-primary ml-2 b-b d-inline-block pb-1'><button type="submit" name="insert" class="btn btn-primary btn-block">Back</button></a>
                                    </div>
                                </div>
                            </div>
