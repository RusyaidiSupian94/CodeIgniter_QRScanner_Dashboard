                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            <center>
                            <img src="<?php echo base_url()?>assets/images/rcm.png" class="img-fluid mb30">
                            <h2 style="margin-bottom:0px; color:#ffffff; font-weight:500" class="mb30">BILANGAN PESERTA<br>RAHSIA CERAMAH MEMUKAU<br><!-- KINI DIBUKA --></h2>
                                    ...
                                    <div class="col-12 bg-primary ml-auto">
                                        <div class = "panel">
                                            ...
                                            <div class = "panel-body text-white mb20">
                                                <?php echo $this->pickup_model->totalpesertarcm();?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb20">
                                    <div class="col-6 bg-warning ">
                                        <div class = "panel">
                                            ...
                                            <div class = "panel-body text-white mb20">
                                                <?php echo $this->pickup_model->bakalhadirrcm();?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 bg-success ml-auto">
                                        <div class = "panel">
                                            ...
                                            <div class = "panel-body text-white mb20">
                                                <?php echo $this->pickup_model->hadirseminarrcm();?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                 	<div class="col-md5 text-center">
                                    	<a href="<?php echo base_url(); ?>pickuprcm/index" class='text-primary ml-2 b-b d-inline-block pb-1'><button type="submit" name="insert" class="btn btn-primary btn-block">Back</button></a>
                                    </div>
                                </div>
                            </div>
