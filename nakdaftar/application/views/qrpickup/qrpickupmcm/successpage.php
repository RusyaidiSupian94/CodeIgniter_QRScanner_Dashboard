                            ...
                            <div class="row">
                                <div class="col-md-12">
                                 	<div class="col-md5 text-center">
                                    	<a href="<?php echo base_url(); ?>pickupqrmcm/index" class='text-primary ml-2 b-b d-inline-block pb-1'><button type="submit" name="insert" class="btn btn-primary btn-block">Back</button></a>
                                    </div>
                                </div>
                            </div>
