                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            ...
                            <h2 style="margin-bottom:0px; color:#ffffff; font-weight:500" class="mb30">PICKUP<br>MASTERY CERAMAH MEMUKAU<br><!-- KINI DIBUKA --></h2>
                           ...
                           <center>
                            ...
                            <center>
                                ...
                                <a href="<?php echo base_url(); ?>pickupmcm/index" class='text-primary ml-2 b-b d-inline-block pb-1'><button type="submit" name="insert" class="btn btn-primary btn-block">INSERT MANUALLY</button></a>
                            </center>
