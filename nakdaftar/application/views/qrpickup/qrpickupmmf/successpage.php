                                    ...
                                    <div class="col-12 bg-primary ml-auto">
                                        <div class = "panel">
                                            ...
                                            <div class = "panel-body text-white mb20">
                                                <?php echo $this->pickup_model->totalpesertammf();?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb20">
                                    <div class="col-6 bg-warning ">
                                        <div class = "panel">
                                            ...
                                            <div class = "panel-body text-white mb20">
                                                <?php echo $this->pickup_model->bakalhadirmmf();?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 bg-success ml-auto">
                                        <div class = "panel">
                                            ...
                                            <div class = "panel-body text-white mb20">
                                                <?php echo $this->pickup_model->hadirseminarmmf();?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md5 text-center">
                                        <a href="<?php echo base_url(); ?>pickupqrmmf/index" class='text-primary ml-2 b-b d-inline-block pb-1'><button type="submit" name="insert" class="btn btn-primary btn-block">Back</button></a>
                                    </div>
                                </div>
                            </div>
