                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mr-auto ml-auto">
                            ...
                            <h2 style="margin-bottom:0px; color:#fff; font-weight:500" class="mb10">ADVANCED MY DOCUMENTS</h2>
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-10">
                            <div class="col-md-3 pull-right">
                                <a href="<?php echo base_url()?>amd/peserta_survey/<?php echo $userdata['nric']; ?>" class="btn btn-primary btn-block">Seterusnya</a>
                            </div>
                        </div>
