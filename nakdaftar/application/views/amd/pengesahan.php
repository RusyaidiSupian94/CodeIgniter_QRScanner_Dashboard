                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mr-auto ml-auto text">
                            <center>
                            <a href="<?php echo base_url()?>amd/logout"><img src="<?php echo base_url()?>assets/images/logo-amd.png" class="img-fluid mb30"></a>

                            <div class=" alert-success alert mb60">
                                <p>Kehadiran anda ke <b>SEMINAR ADVANCED MY DOCUMENTS telah disahkan</b>.<br>Mohon SCREENSHOT INFO di bawah.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 mr-auto ml-auto text" style="border-style: dotted; border-color:#ff0000; border-width:2px; background-color:#fff; ">
                                    ...
                                    <p style="color:#000; font-size:18px; line-height:30px;">Gate No : 
                                        <strong><?php echo $userdata['kaunter']; ?></strong> (Buka 07.30AM)<br>
                                    ...
                                    <center>
                                        <img style="width: 100px;" src="<?php echo base_url().'assets3/images/qrcode/amd/'.$userdata['qrcode'];?>">
                                    </center>
                                </div>
