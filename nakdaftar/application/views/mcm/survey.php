                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            ...
                            <center>
                            <img src="assets/images/rcm.png" width="50%" class="img-fluid mb30">
                            <h2 style="margin-bottom:0px; color:#ffffff; font-weight:500" class="mb30">MASTERY CERAMAH MEMUKAU</h2>
                            ...
                            <form action="<?php echo base_url()?>mcm/peserta_survey_pengesahan" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <!-- <a href="<?php echo base_url()?>mcm/generateQR/<?php echo $userdata['nric']; ?>" class="btn btn-primary btn-block">Seterusnya</a> -->
                                    </div>
                                    </div>
                                </div>
                            </form>
