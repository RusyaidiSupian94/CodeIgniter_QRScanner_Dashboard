                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mr-auto ml-auto text">
                            <center>
                            <a href="<?php echo base_url()?>smh/logout"><img src="<?php echo base_url()?>assets/images/logo-smh.png" class="img-fluid mb30"></a>

                            <div class=" alert-success alert mb60">
                            <p>Kehadiran anda ke <b>SEMINAR MY HUMAN telah disahkan</b>.<br>Mohon SCREENSHOT INFO di bawah.</p>
                            ...
                            <div class="col-lg-8 mr-auto ml-auto text" style="border-style: dotted; border-color:#ff0000; border-width:2px; background-color:#fff; ">
                                ...
                                <center>
                                        <img style="width: 100px;" src="<?php echo base_url().'assets3/images/qrcode/smh/'.$userdata['qrcode'];?>">
                                    </center>
                            </div>
