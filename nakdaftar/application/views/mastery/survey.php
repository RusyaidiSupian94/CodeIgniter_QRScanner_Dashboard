                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            ...
                            <h2 style="margin-bottom:0px; color:#ffffff; font-weight:500" class="mb30">MASTERY MY FINANCE</h2>
                            ...
                            <form action="<?php echo base_url()?>mastery/peserta_survey_pengesahan" method="POST">
                                ...
                                <div class="row control-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="email" class="form-control" placeholder="Emel Peserta" name="email" required="">
                                    </div>
                                </div>
