                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            ...
                            <h2 style="margin-bottom:0px; color:#ffffff; font-weight:500" class="mb30">PENGESAHAN KEHADIRAN<br>MASTERY MY FINANCE<br>KINI DIBUKA</h2>

                            <p style="color:#fff100"><strong>Langkah 1 :</strong> Mohon masukkan No.IC untuk mengesahkan kehadiran.</p>
                            </center>
                            ...
                            <form action="<?php echo base_url()?>mastery/login_validation" method="POST">
                                <div class="row">
                                    <div class="col-md-12">
