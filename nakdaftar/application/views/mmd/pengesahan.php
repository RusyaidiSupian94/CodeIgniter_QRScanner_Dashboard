                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 mr-auto ml-auto text">
                            <center>
                            <a href="<?php echo base_url()?>mmd/logout"><img src="<?php echo base_url()?>assets/images/mmd-logo.png" class="img-fluid mb30"></a>

                            <div class=" alert-success alert mb60">
                                <p>Kehadiran anda ke <b>MASTERY ADVANCED MY DOCUMENTS telah disahkan</b>.<br>Mohon SCREENSHOT INFO di bawah.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 mr-auto ml-auto text" style="border-style: dotted; border-color:#ff0000; border-width:2px; background-color:#fff; ">
                                    ...
                                    <center>
                                        <img style="width: 70%;" src="<?php echo base_url().'assets3/images/qrcode/mmd/'.$userdata['qrcode'];?>">
                                    </center>
