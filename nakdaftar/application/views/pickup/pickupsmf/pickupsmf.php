                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            ...
                            <h2 style="margin-bottom:0px; color:#ffffff; font-weight:500" class="mb30">PICKUP<br>SEMINAR MY FINANCE<br><!-- KINI DIBUKA --></h2>
                            ...
                            <center><a href="<?php echo base_url(); ?>pickupqrsmf/index" class='text-primary ml-2 b-b d-inline-block pb-1'><button class="btn btn-primary btn-block">Scan QR Code</button></a></center>

                            <form action="<?php echo base_url()?>pickupsmf/validation" method="POST">
                                <div class="row">
                                    <div class="col-md-12">
