                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-10 mr-auto ml-auto">
                            ...
                            <center><a href="<?php echo base_url(); ?>pickupqrmcm/index" class='text-primary ml-2 b-b d-inline-block pb-1'><button class="btn btn-primary btn-block">Scan QR Code</button></a></center>

                            <form action="<?php echo base_url()?>pickupmcm/validation" method="POST">
                                <div class="row">
                                    <div class="col-md-12">
