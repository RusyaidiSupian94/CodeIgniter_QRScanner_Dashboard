                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3" >
                                            ...
                                            <!-- <table class="table table-striped table-bordered" > --><!--style="overflow-x:auto;"--->
                                                ...
                                                <tbody>
                                                    <?php if(!empty($cust_data2)){ foreach($cust_data2 as $row){ ?><!--testing tu table database to call each role--->
                                                    <tr>
                                                        ...
                                                        <th >
                                                            <a href="<?php echo site_url('updateda/view/'.$row['cust_id']);?>" class="btn btn-success"><div>View</div></a>
                                                            <a href="<?php echo site_url('updateda/edit/'.$row['cust_id']); ?>" class="btn btn-warning"><div>Edit</div></a>
