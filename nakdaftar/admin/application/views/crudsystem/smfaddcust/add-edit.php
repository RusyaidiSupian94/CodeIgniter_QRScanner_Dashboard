                ...
                <div class="portlet-box">
                    <div class="portlet-header flex-row b-b flex d-flex align-items-center">
                        <div class="flex d-flex flex-column text-center">
                            <h3>UPDATE FORM SMF <?php echo $updatedatasmf['no_siri']; ?></h3>
                        </div>
                    </div>
                                    ...
                                    <form action="" method="post" ><!--------action="<?php echo base_url('CSVcodex/edit'); ?>"--->
                                        <div class="form-row">
                                            <div class="col-md-4 mb-3">
                                                <label>NO SIRI</label>
                                                <input type="text" class="form-control" name="no_siri" placeholder="" value="<?php echo !empty($updatedatasmf['no_siri'])?$updatedatasmf['no_siri']:''; ?>" >
                                                <?php echo form_error('no_siri','<div class="invalid-feedback">','</div>'); ?>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>NAME</label>
                                                <input type="text" class="form-control" name="name" placeholder="ENTER YOUR NAME" value="<?php echo !empty($updatedatasmf['name'])?$updatedatasmf['name']:''; ?>" >
                                                <?php echo form_error('name','<div class="invalid-feedback">','</div>'); ?>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>PHONE</label>
                                                <input type="text" class="form-control" name="phone" placeholder="ENTER YOUR PHONE NUMBER" value="<?php echo !empty($updatedatasmf['phone'])?$updatedatasmf['phone']:''; ?>" >
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 mb-3">
                                                <label>EMAIL</label>
                                                <input type="text" class="form-control" name="email" placeholder="ENTER YOUR EMAIL" value="<?php echo !empty($updatedatasmf['email'])?$updatedatasmf['email']:''; ?>" >
                                                <?php echo form_error('email','<div class="invalid-feedback">','</div>'); ?>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>NRIC</label>
                                                <input type="text" class="form-control" name="nric" placeholder="ENTER YOUR NRIC" value="<?php echo !empty($updatedatasmf['nric'])?$updatedatasmf['nric']:''; ?>" >
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="gender">
                                                        <option value="<?php echo !empty($updatedatasmf['gender'])?$updatedatasmf['gender']:''; ?>">Select your gender ( <?php echo $updatedatasmf['gender']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="size">
                                                        <option value="<?php echo !empty($updatedatasmf['size'])?$updatedatasmf['size']:''; ?>">Select your size ( <?php echo $updatedatasmf['size']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="tiket">
                                                        <option value="<?php echo !empty($updatedatasmf['tiket'])?$updatedatasmf['tiket']:''; ?>">Select your tiket ( <?php echo $updatedatasmf['tiket']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="kaunter">
                                                        <option value="<?php echo !empty($updatedatasmf['kaunter'])?$updatedatasmf['kaunter']:''; ?>">Select Your Kaunter ( <?php echo $updatedatasmf['kaunter']; ?> )</option>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="state">
                                                        <option value="<?php echo !empty($updatedatasmf['state'])?$updatedatasmf['state']:''; ?>">Select Your State ( <?php echo $updatedatasmf['state']; ?> )</option>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label>COUNTRY</label>
                                                <input type="text" class="form-control" name="country" placeholder="ENTER YOUR COUNTRY" value="<?php echo !empty($updatedatasmf['country'])?$updatedatasmf['country']:''; ?>" >
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="company" placeholder="ENTER YOUR COMPANY NAME" value="<?php echo !empty($updatedatasmf['company'])?$updatedatasmf['company']:''; ?>" >
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="status">
                                                        <option value="<?php echo !empty($updatedatasmf['status'])?$updatedatasmf['status']:''; ?>">Select Your Status ( <?php echo $updatedatasmf['status']; ?> )</option>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="industry">
                                                        <option value="<?php echo !empty($updatedatasmf['industry'])?$updatedatasmf['industry']:''; ?>">Select Your INDUSTRY ( <?php echo $updatedatasmf['industry']; ?> )</option>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="working">
                                                        <option value="<?php echo !empty($updatedatasmf['working'])?$updatedatasmf['working']:''; ?>">Select JAWATAN ( <?php echo $updatedatasmf['working']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="hope">
                                                        <option value="<?php echo !empty($updatedatasmf['hope'])?$updatedatasmf['hope']:''; ?>">HARAPAN ( <?php echo $updatedatasmf['hope']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="interest">
                                                        <option value="<?php echo !empty($updatedatasmf['interest'])?$updatedatasmf['interest']:''; ?>">( <?php echo $updatedatasmf['interest']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="funnel">
                                                        <option value="<?php echo !empty($updatedatasmf['funnel'])?$updatedatasmf['funnel']:''; ?>">( <?php echo $updatedatasmf['funnel']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="experience">
                                                        <option value="<?php echo !empty($updatedatasmf['experience'])?$updatedatasmf['experience']:''; ?>">( <?php echo $updatedatasmf['experience']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="investment">
                                                        <option value="<?php echo !empty($updatedatasmf['investment'])?$updatedatasmf['investment']:''; ?>">( <?php echo $updatedatasmf['investment']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="income">
                                                        <option value="<?php echo !empty($updatedatasmf['income'])?$updatedatasmf['income']:''; ?>">( <?php echo $updatedatasmf['income']; ?> )</option>
                                        ...
                                        <a href="<?php echo site_url('smfimport'); ?>" class="btn btn-secondary">Back</a>
