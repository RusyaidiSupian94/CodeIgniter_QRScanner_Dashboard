                ...
                <div class="portlet-box">
                    <div class="portlet-header flex-row b-b flex d-flex align-items-center">
                        <div class="flex d-flex flex-column text-center">
                            <h3>UPDATE FORM AMD <?php echo $updatedataamd['no_siri']; ?> </h3>
                        </div>
                    </div>
                                    ...
                                    <form action="" method="post" ><!--------action="<?php echo base_url('CSVcodex/edit'); ?>"--->
                                        <div class="form-row">
                                            <div class="col-md-4 mb-3">
                                                <label>NO SIRI</label>
                                                <input type="text" class="form-control" name="no_siri" placeholder="" value="<?php echo !empty($updatedataamd['no_siri'])?$updatedataamd['no_siri']:''; ?>" >
                                                <?php echo form_error('no_siri','<div class="invalid-feedback">','</div>'); ?>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>NAME</label>
                                                <input type="text" class="form-control" name="name" placeholder="ENTER YOUR NAME" value="<?php echo !empty($updatedataamd['name'])?$updatedataamd['name']:''; ?>" >
                                                <?php echo form_error('name','<div class="invalid-feedback">','</div>'); ?>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>PHONE</label>
                                                <input type="text" class="form-control" name="phone" placeholder="ENTER YOUR PHONE NUMBER" value="<?php echo !empty($updatedataamd['phone'])?$updatedataamd['phone']:''; ?>" >
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 mb-3">
                                                <label>EMAIL</label>
                                                <input type="text" class="form-control" name="email" placeholder="ENTER YOUR EMAIL" value="<?php echo !empty($updatedataamd['email'])?$updatedataamd['email']:''; ?>" >
                                                <?php echo form_error('email','<div class="invalid-feedback">','</div>'); ?>
                                            </div>
                                            <div class="col-md-4 mb-3">
                                                <label>NRIC</label>
                                                <input type="text" class="form-control" name="nric" placeholder="ENTER YOUR NRIC" value="<?php echo !empty($updatedataamd['nric'])?$updatedataamd['nric']:''; ?>" >
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="gender">
                                                        <option value="<?php echo !empty($updatedataamd['gender'])?$updatedataamd['gender']:''; ?>">Select your gender ( <?php echo $updatedataamd['gender']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="size">
                                                        <option value="<?php echo !empty($updatedataamd['size'])?$updatedataamd['size']:''; ?>">Select your size ( <?php echo $updatedataamd['size']; ?> )</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="tiket">
                                                        <option value="<?php echo !empty($updatedataamd['tiket'])?$updatedataamd['tiket']:''; ?>">Select your tiket ( <?php echo $updatedataamd['tiket']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="kaunter">
                                                        <option value="<?php echo !empty($updatedataamd['kaunter'])?$updatedataamd['kaunter']:''; ?>">Select Your Kaunter ( <?php echo $updatedataamd['kaunter']; ?> )</option>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="state">
                                                        <option value="<?php echo !empty($updatedataamd['state'])?$updatedataamd['state']:''; ?>">Select Your State ( <?php echo $updatedataamd['state']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <label>COUNTRY</label>
                                                <input type="text" class="form-control" name="country" placeholder="ENTER YOUR COUNTRY" value="<?php echo !empty($updatedataamd['country'])?$updatedataamd['country']:''; ?>" >
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="company" placeholder="ENTER YOUR COMPANY NAME" value="<?php echo !empty($updatedataamd['company'])?$updatedataamd['company']:''; ?>" >
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="status">
                                                        <option value="<?php echo !empty($updatedataamd['status'])?$updatedataamd['status']:''; ?>">Select Your Status ( <?php echo $updatedataamd['status']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="industry">
                                                        <option value="<?php echo !empty($updatedataamd['industry'])?$updatedataamd['industry']:''; ?>">Select Your INDUSTRY ( <?php echo $updatedataamd['industry']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="working">
                                                        <option value="<?php echo !empty($updatedataamd['working'])?$updatedataamd['working']:''; ?>">Select JAWATAN ( <?php echo $updatedataamd['working']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="hope">
                                                        <option value="<?php echo !empty($updatedataamd['hope'])?$updatedataamd['hope']:''; ?>">HARAPAN ( <?php echo $updatedataamd['hope']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="interest">
                                                        <option value="<?php echo !empty($updatedataamd['interest'])?$updatedataamd['interest']:''; ?>">SEBAB HADIR ( <?php echo $updatedataamd['interest']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="funnel">
                                                        <option value="<?php echo !empty($updatedataamd['funnel'])?$updatedataamd['funnel']:''; ?>">( <?php echo $updatedataamd['funnel']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="experience">
                                                        <option value="<?php echo !empty($updatedataamd['experience'])?$updatedataamd['experience']:''; ?>">( <?php echo $updatedataamd['experience']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="investment">
                                                        <option value="<?php echo !empty($updatedataamd['investment'])?$updatedataamd['investment']:''; ?>">( <?php echo $updatedataamd['investment']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="exampleFormControlSelect1" name="income">
                                                        <option value="<?php echo !empty($updatedataamd['income'])?$updatedataamd['income']:''; ?>">( <?php echo $updatedataamd['income']; ?> )</option>
                                                        <option value="NA">NON AVAILABLE</option>
                                        ...
                                        <a href="<?php echo site_url('amdimport'); ?>" class="btn btn-secondary">Back</a>
