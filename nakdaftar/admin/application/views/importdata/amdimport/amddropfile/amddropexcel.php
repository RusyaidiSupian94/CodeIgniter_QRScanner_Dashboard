                                        ...
                                        <!-- Import link -->
                                            <div class="col-md-12 head">
                                                <div class="float-right">
                                                    ...
                                                    <a href="<?php echo site_url('updatedaamd/add'); ?>" class="btn btn-success">ADD</a>
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        ...
                                        <div class="col-md-12" id="importFrm" style="display: none;">
                                            <div><p>Sila download file ini untuk dapatkan file csv</p>
                                                <a href="<?php echo base_url().'download/lakukan_download' ?>">Download file</a><br><br>
                                            </div>
                                            <form action="<?php echo base_url('amdimport/import'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12" id="exportFrm" style="display: none;">
                                           <!--  <form action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <a href="<?php echo site_url('Exportamd/generateXlsx'); ?>" class="btn btn-primary">.xlsx</a>
                                            <a href="<?php echo site_url('Exportamd/generateXls'); ?>" class="btn btn-primary">.xls</a>
                                            <a href="<?php echo site_url('Exportamd/generateCsv'); ?>" class="btn btn-primary">.csv</a>
                                        </div>
                                        ...
                                        <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3" >
                                            ...
                                            <!-- <table class="table table-striped table-bordered" > --><!--style="overflow-x:auto;"--->
                                                ...
                                                <tbody>
                                                    <?php if(!empty($amd)){ foreach($amd as $row){ ?><!--testing tu table database to call each role--->
                                                    <tr>
                                                        ...
                                                        <th >
                                                            <a href="<?php echo site_url('updatedaamd/view/'.$row['id']);?>" class="btn btn-success"><div>View</div></a>
                                                            <a href="<?php echo site_url('updatedaamd/edit/'.$row['id']); ?>" class="btn btn-warning"><div>Edit</div></a>
                                                            <a href="<?php echo site_url('updatedaamd/delete/'.$row['id']); ?>" class="btn btn-danger"><div>Delete</div></a>
