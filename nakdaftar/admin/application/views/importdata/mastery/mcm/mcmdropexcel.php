                                ...
                                <div class="portlet-box">
                                        ...
                                        <!-- Import link -->
                                            <div class="col-md-12 head">
                                                <div class="float-right">
                                                    ...
                                                    <a href="<?php echo site_url('updatedamcm/add'); ?>" class="btn btn-success">ADD</a>
                                                </div>
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        ...
                                        <div class="col-md-12" id="importFrm" style="display: none;">
                                            ...
                                            <div><p>Sila download file ini untuk dapatkan file csv</p>
                                                <a href="<?php echo base_url().'download/lakukan_downloadmastery' ?>">Download file</a><br><br>
                                            </div>

                                            <form action="<?php echo base_url('mcmimport/import'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12" id="exportFrm" style="display: none;">
                                            <a href="<?php echo site_url('Exportmcm/generateXlsx'); ?>" class="btn btn-primary">.xlsx</a>
                                            <a href="<?php echo site_url('Exportmcm/generateXls'); ?>" class="btn btn-primary">.xls</a>
                                            <a href="<?php echo site_url('Exportmcm/generateCsv'); ?>" class="btn btn-primary">.csv</a>
                                        </div>
                                        ...
                                        <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3" >
                                            ...
                                            <!-- <table class="table table-striped table-bordered" > --><!--style="overflow-x:auto;"--->
                                                ...
                                                <tbody>
                                                    <?php if(!empty($mcm)){ foreach($mcm as $row){ ?><!--testing tu table database to call each role--->
                                                    <tr>
                                                        ...
                                                        <!--<td><img style="width: 100px;" src="<?php echo base_url().'assets3/qrcode/amd/'.$row['qrcode'];?>"></td>-->
                                                        <!-- <td><?php echo $row['size']; ?></td>
                                                        <td><?php echo $row['tiket']; ?></td> -->
                                                        <th >
                                                            <a href="<?php echo site_url('updatedamcm/view/'.$row['id']);?>" class="btn btn-success"><div>View</div></a>
                                                            <a href="<?php echo site_url('updatedamcm/edit/'.$row['id']); ?>" class="btn btn-warning"><div>Edit</div></a>
                                                            <a href="<?php echo site_url('updatedamcm/delete/'.$row['id']); ?>" class="btn btn-danger"><div>Delete</div></a>
