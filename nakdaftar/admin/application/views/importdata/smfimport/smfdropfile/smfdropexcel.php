                                ...
                                <div class="portlet-box">
                                        ...
                                        <!-- Import link -->
                                            <div class="col-md-12 head">
                                                <div class="float-right">
                                                    ...
                                                    <a href="<?php echo site_url('updatedasmf/add'); ?>" class="btn btn-success">ADD</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">
                                        ...
                                        <div class="col-md-12" id="importFrm" style="display: none;">
                                            <form action="<?php echo base_url('smfimport/import'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-12" id="exportFrm" style="display: none;">
                                            <a href="<?php echo site_url('Exportsmf/generateXlsx'); ?>" class="btn btn-primary">.xlsx</a>
                                            <a href="<?php echo site_url('Exportsmf/generateXls'); ?>" class="btn btn-primary">.xls</a>
                                            <a href="<?php echo site_url('Exportsmf/generateCsv'); ?>" class="btn btn-primary">.csv</a>
                                        </div>
                                        ...
                                        <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3" >
                                            ...
                                            <!-- <table class="table table-striped table-bordered" > --><!--style="overflow-x:auto;"--->
                                                ...
                                                <tbody>
                                                    <?php if(!empty($smf)){ foreach($smf as $row){ ?><!--testing tu table database to call each role--->
                                                    <tr>
                                                        ...
                                                        <!--<td><img style="width: 100px;" src="<?php echo base_url().'assets/images/qrcode/smf/'.$row['qrcode'];?>"></td>-->
                                                        <th >
                                                            <a href="<?php echo site_url('updatedasmf/view/'.$row['id']);?>" class="btn btn-success"><div>View</div></a>
                                                            <a href="<?php echo site_url('updatedasmf/edit/'.$row['id']); ?>" class="btn btn-warning"><div>Edit</div></a>
                                                            <a href="<?php echo site_url('updatedasmf/delete/'.$row['id']); ?>" class="btn btn-danger"><div>Delete</div></a>
