<div class="row d-flex justify-content-center">
    <div class="col-lg-4 mb-20">
        <div class="rounded shadow-sm" style="background: #810808"><!----------style="background: #ff0000"---->
            <img src="<?php echo base_url();?>assets/images/rcm.png" alt="" class="img-fluid  ml-auto mr-auto d-block p-4">
            <div class="text-center text-white">
                <h5 class=" mb-0">RAHSIA CERAMAH MEMUKAU</h5>
                <span class="text-muted  d-block pb-2">9 - 10 November <?php echo date("Y"); ?></span>
                <div class="clearifx pb-3">
                    <span class="p-2 text-center d-inline-block ">
                        <span class="pt-1  fs-1x"><?php echo $this->modelrcm->rcmgenderL();?></span><br>
                        <span class="pt-1  fs12 text-muted">Male</span>
                    </span>
                    <span class="p-2 text-center d-inline-block ">
                        <span class="pt-1  fs-1x"><?php echo $this->modelrcm->rcmgenderP();?></span><br>
    ...
    <div class="col-lg-4 mb-20 text-white">
        <div class="p-2 text-center rounded mb-10" style="background: #4A0000"><!--si-colored-facebook--->
            <div class="text-center pt-15">

                <span class=" fs-3x lineH-1 font300 d-block"><?php echo $this->modelrcm->rcmdaftar();?></span>
                <span class=" text-muted fs-1x d-block">Peserta Berdaftar</span>
                <i class="d-block pt-1 fs-2x fas fa-users"></i>
            </div>
        </div>
        <div class="p-2 text-center rounded" style="background: #AB5050"><!---si-colored-twitter-->
            <div class="text-center pt-15">

                <span class=" fs-3x lineH-1 font300 d-block"><?php echo $this->modelrcm->rcmhadir();?></span>
                ...
                <div class="list bg-primary shadow-sm rounded overflow-hidden">
                    <div class="list-item">
                        ...
                        <div class="list-body text-right">
                            <span class="list-title fs-2x  lineH-1"><?php echo $this->chart_model->yghadirrcm();?></span>
            ...
            <div class="col-lg-4 mb-6 col-md-6 mb-30">
                <div class="list bg-danger shadow-sm rounded overflow-hidden">
                    <div class="list-item">
                        ...
                        <div class="list-body text-right">
                            <span class="list-title fs-2x lineH-1"><?php echo $this->chart_model->ygsahkanrcm();?></span>
            ...
            <div class="col-lg-4 mb-6 col-md-6 mb-30">
                <div class="list bg-success shadow-sm rounded overflow-hidden">
                    <div class="list-item">
                        ...
                        <div class="list-body text-right">
                            <span class="list-title fs-2x  lineH-1"><?php echo $this->chart_model->daftarrcm();?></span>
