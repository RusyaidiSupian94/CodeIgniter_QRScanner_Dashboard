...
class Exportrcm extends MY_Controller {
    // construct
    public function __construct() {
        parent::__construct();
        // load model
        $this->load->model('Export_modelrcm', 'export');
    }    
    ...
    public function generateXlsx() {
        ...
        ////////////////////////////////////xlsx////////////////
        $filename = "RCM Excel2007 ". date("Y-m-d").".xlsx";
    ...
    public function generateXls() {
        ...
        ///////////////////////////xls//////
        $filename = "RCM Excel2005 ". date("Y-m-d").".xls";
    ...
    public function generateCsv() {
        ...
        //////////////////////csv////////////////////
        $filename = "RCM CSV ". date("Y-m-d").".csv";///////this for name file and date
        header('Content-Type: application/vnd.ms-excel'); 
        header('Content-Disposition: attachment;filename="'.$filename.'"');
        header('Cache-Control: max-age=0'); 
