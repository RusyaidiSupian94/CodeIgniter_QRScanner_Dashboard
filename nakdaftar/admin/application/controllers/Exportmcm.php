...
class Exportmcm extends MY_Controller {
    // construct
    public function __construct() {
        parent::__construct();
        // load model
        $this->load->model('Export_modelmcm', 'export');
    }    
    ...
    public function generateXlsx() {
        ...
        $objPHPExcel->getActiveSheet()->SetCellValue('F1', 'Kehadiran');
        // set Row
        $rowCount = 2;
        foreach ($listInfo as $list) {
            ...
            $objPHPExcel->getActiveSheet()->SetCellValue('F'. $rowCount, $list->kehadiran); 
            $rowCount++;
        }
        ////////////////////////////////////xlsx////////////////
        $filename = "MCM Excel2007 ". date("Y-m-d").".xlsx";
    ...
    public function generateXls() {
        ...
        ///////////////////////////xls//////
        $filename = "MCM Excel2005 ". date("Y-m-d").".xls";
    ...
    public function generateCsv() {
        ...
        //////////////////////csv////////////////////
        $filename = "MCM CSV ". date("Y-m-d").".csv";///////this for name file and date
        header('Content-Type: application/vnd.ms-excel'); 
        header('Content-Disposition: attachment;filename="'.$filename.'"');
        header('Cache-Control: max-age=0'); 
