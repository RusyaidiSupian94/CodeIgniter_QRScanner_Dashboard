...
class SmhImport extends MY_Controller {
    
    function __construct() {
        parent::__construct();
        
        // Load member model
        $this->load->model('smhmodelimport');
    ...
    public function index(){///to show dataset or datatable
        ...
        // Get rows
        $data['smh'] = $this->smhmodelimport->getRows();///dalam data tu table database
        ...
        $this->account();
        $this->load->view('importdata/smhimport/smhdropfile/smhdropdashboard');
        $this->load->view('importdata/smhimport/smhdropfile/smhdropexcel',$data);
                ...
                if(is_uploaded_file($_FILES['file']['tmp_name'])){
                    ...
                    if(!empty($csvData)){
                        foreach($csvData as $row){ $rowCount++;
                            ...
                            $prevCount = $this->smhmodelimport->getRows($con);///call the funtion at csvcodexmodel
                            ...
                            //         // 'income' => $row['Income'],
                                ...
                                $update = $this->smhmodelimport->update($memData, $condition);
                                ...
                                // Insert member data
                                $insert = $this->smhmodelimport->insert($memData);
