...
class Updatedammh extends MY_Controller {
    ...
    public function view($id){
        ...
        if(!empty($id)){
            $data['updatedatammh'] = $this->updatedatammh->getRows(array('id' => $id));;///in the data bracket there are model there
            ...
            $this->load->view('crudsystem/mmhaddcust/view', $data);
    ...
    public function edit($id){
        ...
        // Get member data
        $memData = $this->updatedatammh->getRows(array('id' => $id));
        ...
        if($this->input->post('memSubmit')){
            ...
            //     // Update member data
            //     $update = $this->updatedatammh->update($memData, $id);
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/mmhaddcust/dashboardupdate');
        $this->load->view('crudsystem/mmhaddcust/add-edit',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function add(){
        ...
        if($this->input->post('memSubmit')){
            ...
            $config['imagedir']     = '../assets3/images/qrcode/mmh/'; //direktori penyimpanan qr code
            ...
            if($this->form_validation->run() == true){
                // Insert member data
                $insert = $this->updatedatammh->insert($memData);
       ...
       $data['updatedatammh'] = $memData;
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/mmhaddcust/dashboardadd');
        $this->load->view('crudsystem/mmhaddcust/addcust',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function delete($id){
        ...
        if($id){
            ...
            $delete = $this->updatedatammh->delete($id);
...
//////////////////////////////checking same data/////////////
    public function nric_check($str){
        ...
        $checkNric = $this->updatedatammh->getRows2($con);
        if($checkNric > 0){
    ...
    public function no_siri_check($str){
        ...
        $checkNo_siri = $this->updatedatammh->getRows2($con);
        if($checkNo_siri > 0){
