...
class Mcmimport extends MY_Controller {
    
    function __construct() {
        parent::__construct();
        
        // Load member model
        $this->load->model('mcmmodelimport');
    ...
    public function index(){///to show dataset or datatable
        ...
        // Get rows
        $data['mcm'] = $this->mcmmodelimport->getRows();///dalam data tu table database
        ...
        $this->account();
        $this->load->view('importdata/mastery/mcm/mcmdropdashboard');
        $this->load->view('importdata/mastery/mcm/mcmdropexcel',$data);
                ...
                if(is_uploaded_file($_FILES['file']['tmp_name'])){
                    ...
                    if(!empty($csvData)){
                        foreach($csvData as $row){ $rowCount++;
                            ...
                            $prevCount = $this->mcmmodelimport->getRows($con);///call the funtion at csvcodexmodel
                            ...
                            //         // 'income' => $row['Income'],
                                ...
                                $update = $this->mcmmodelimport->update($memData, $condition);
                                ...
                                // Insert member data
                                $insert = $this->mcmmodelimport->insert($memData);
