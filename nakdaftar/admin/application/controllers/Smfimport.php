...
class SmfImport extends MY_Controller {
    
    function __construct() {
        parent::__construct();
        
        // Load member model
        $this->load->model('smfmodelimport');
    ...
    public function index(){///to show dataset or datatable
        ...
        // Get rows
        $data['smf'] = $this->smfmodelimport->getRows();///dalam data tu table database
        ...
        $this->account();
        $this->load->view('importdata/smfimport/smfdropfile/smfdropdashboard');
        $this->load->view('importdata/smfimport/smfdropfile/smfdropexcel',$data);
                ...
                if(is_uploaded_file($_FILES['file']['tmp_name'])){
                    ...
                    if(!empty($csvData)){
                        foreach($csvData as $row){ $rowCount++;
                            ...
                            $prevCount = $this->smfmodelimport->getRows($con);///call the funtion at csvcodexmodel
                            ...
                            //         // 'income' => $row['Income'],
                                ...
                                $update = $this->smfmodelimport->update($memData, $condition);
                                ...
                                // Insert member data
                                $insert = $this->smfmodelimport->insert($memData);
