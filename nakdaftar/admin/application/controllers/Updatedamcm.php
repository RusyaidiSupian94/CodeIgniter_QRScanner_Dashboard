...
class Updatedamcm extends MY_Controller {
    ...
    public function view($id){
        ...
        if(!empty($id)){
            $data['updatedatamcm'] = $this->updatedatamcm->getRows(array('id' => $id));;///in the data bracket there are model there
            ...
            $this->load->view('crudsystem/mcmaddcust/view', $data);
    ...
    public function edit($id){
        ...
        // Get member data
        $memData = $this->updatedatamcm->getRows(array('id' => $id));
        ...
        if($this->input->post('memSubmit')){
            ...
            //     // Update member data
            //     $update = $this->updatedatamcm->update($memData, $id);
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/mcmaddcust/dashboardupdate');
        $this->load->view('crudsystem/mcmaddcust/add-edit',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function add(){
        ...
        if($this->input->post('memSubmit')){
            ...
            // $config['imagedir']     = '../assets3/images/qrcode/mcm/'; //direktori penyimpanan qr code
            ...
            if($this->form_validation->run() == true){
                // Insert member data
                $insert = $this->updatedatamcm->insert($memData);
       ...
       $data['updatedatamcm'] = $memData;
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/mcmaddcust/dashboardadd');
        $this->load->view('crudsystem/mcmaddcust/addcust',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function delete($id){
        ...
        if($id){
            ...
            $delete = $this->updatedatamcm->delete($id);
...
//////////////////////////////checking same data/////////////
    public function nric_check($str){
        ...
        $checkNric = $this->updatedatamcm->getRows2($con);
        if($checkNric > 0){
    ...
    public function no_siri_check($str){
        ...
        $checkNo_siri = $this->updatedatamcm->getRows2($con);
        if($checkNo_siri > 0){
