...
class Mmhimport extends MY_Controller {
    
    function __construct() {
        parent::__construct();
        
        // Load member model
        $this->load->model('mmhmodelimport');
    ...
    public function index(){///to show dataset or datatable
        ...
        // Get rows
        $data['mmh'] = $this->mmhmodelimport->getRows();///dalam data tu table database
        ...
        $this->account();
        $this->load->view('importdata/mastery/mmh/mmhdropdashboard');
        $this->load->view('importdata/mastery/mmh/mmhdropexcel',$data);
                ...
                if(is_uploaded_file($_FILES['file']['tmp_name'])){
                    ...
                    if(!empty($csvData)){
                        foreach($csvData as $row){ $rowCount++;
                            ...
                            $prevCount = $this->mmhmodelimport->getRows($con);///call the funtion at csvcodexmodel
                            ...
                            //         // 'income' => $row['Income'],
                                ...
                                $update = $this->mmhmodelimport->update($memData, $condition);
                                ...
                                // Insert member data
                                $insert = $this->mmhmodelimport->insert($memData);
