...
class Updatedaamd extends MY_Controller {
    ...
    public function view($id){
        ...
        if(!empty($id)){
            $data['updatedataamd'] = $this->updatedataamd->getRows(array('id' => $id));;///in the data bracket there are model there
            ...
            $this->load->view('crudsystem/amdaddcust/view', $data);
    ...
    public function edit($id){
        ...
        // Get member data
        $memData = $this->updatedataamd->getRows(array('id' => $id));
        ...
        if($this->input->post('memSubmit')){
            ...
            //     // Update member data
            //     $update = $this->updatedataamd->update($memData, $id);
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/amdaddcust/dashboardupdate');
        $this->load->view('crudsystem/amdaddcust/add-edit',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function add(){
        ...
        if($this->input->post('memSubmit')){
            ...
            $config['imagedir']     = '../assets3/images/qrcode/amd/'; //direktori penyimpanan qr code
            ...
            if($this->form_validation->run() == true){
                // Insert member data
                $insert = $this->updatedataamd->insert($memData);
       ...
       $data['updatedataamd'] = $memData;
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/amdaddcust/dashboardadd');
        $this->load->view('crudsystem/amdaddcust/addcust',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function delete($id){
        ...
        if($id){
            ...
            $delete = $this->updatedataamd->delete($id);
...
//////////////////////////////checking same data/////////////
    public function nric_check($str){
        ...
        $checkNric = $this->updatedataamd->getRows2($con);
        if($checkNric > 0){
    ...
    public function no_siri_check($str){
        ...
        $checkNo_siri = $this->updatedataamd->getRows2($con);
        if($checkNo_siri > 0){
