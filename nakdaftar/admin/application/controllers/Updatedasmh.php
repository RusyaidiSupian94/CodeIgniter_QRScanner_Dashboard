...
class Updatedasmh extends MY_Controller {
    ...
    public function view($id){
        ...
        if(!empty($id)){
            $data['updatedatasmh'] = $this->updatedatasmh->getRows(array('id' => $id));;///in the data bracket there are model there
            ...
            $this->load->view('crudsystem/smhaddcust/view', $data);
    ...
    public function edit($id){
        ...
        // Get member data
        $memData = $this->updatedatasmh->getRows(array('id' => $id));
        ...
        if($this->input->post('memSubmit')){
            ...
            // if($this->form_validation->run() == true){
                // Update member data
                $update = $this->updatedatasmh->update($memData, $id);
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/smhaddcust/dashboardupdate');
        $this->load->view('crudsystem/smhaddcust/add-edit',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function add(){
        ...
        if($this->input->post('memSubmit')){
            ...
            $config['imagedir']     = '../assets3/images/qrcode/smh/'; //direktori penyimpanan qr code
            ...
            if($this->form_validation->run() == true){
                // Insert member data
                $insert = $this->updatedatasmh->insert($memData);
       ...
       $data['updatedatasmh'] = $memData;
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/smhaddcust/dashboardadd');
        $this->load->view('crudsystem/smhaddcust/addcust',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function delete($id){
        ...
        if($id){
            ...
            $delete = $this->updatedatasmh->delete($id);
...
//////////////////////////////checking same data/////////////
    public function nric_check($str){
        ...
        $checkNric = $this->updatedatasmh->getRows2($con);
        if($checkNric > 0){
    ...
    public function no_siri_check($str){
        ...
        $checkNo_siri = $this->updatedatasmh->getRows2($con);
        if($checkNo_siri > 0){
