...
class Updatedammf extends MY_Controller {
    ...
    public function view($id){
        ...
        if(!empty($id)){
            $data['updatedatammf'] = $this->updatedatammf->getRows(array('id' => $id));;///in the data bracket there are model there
            ...
            $this->load->view('crudsystem/mmfaddcust/view', $data);
    ...
    public function edit($id){
        ...
        // Get member data
        $memData = $this->updatedatammf->getRows(array('id' => $id));
        ...
        if($this->input->post('memSubmit')){
            ...
            //     // Update member data
            //     $update = $this->updatedatammf->update($memData, $id);
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/mmfaddcust/dashboardupdate');
        $this->load->view('crudsystem/mmfaddcust/add-edit',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function add(){
        ...
        if($this->input->post('memSubmit')){
            ...
            if($this->form_validation->run() == true){
                // Insert member data
                $insert = $this->updatedatammf->insert($memData);
       ...
       $data['updatedatammf'] = $memData;
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/mmfaddcust/dashboardadd');
        $this->load->view('crudsystem/mmfaddcust/addcust',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function delete($id){
        ...
        if($id){
            ...
            $delete = $this->updatedatammf->delete($id);
...
//////////////////////////////checking same data/////////////
    public function nric_check($str){
        ...
        $checkNric = $this->updatedatammf->getRows2($con);
        if($checkNric > 0){
    ...
    public function no_siri_check($str){
        ...
        $checkNo_siri = $this->updatedatammf->getRows2($con);
        if($checkNo_siri > 0){
