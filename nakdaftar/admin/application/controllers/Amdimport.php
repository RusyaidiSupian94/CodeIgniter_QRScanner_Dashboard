...
class AmdImport extends MY_Controller {
    
    function __construct() {
        parent::__construct();
        
        // Load member model
        $this->load->model('amdmodelimport');
    ...
    public function index(){///to show dataset or datatable
        ...
        // Get rows
        $data['amd'] = $this->amdmodelimport->getRows();///dalam data tu table database
        ...
        $this->account();
        $this->load->view('importdata/amdimport/amddropfile/amddropdashboard');
        $this->load->view('importdata/amdimport/amddropfile/amddropexcel',$data);
                ...
                if(is_uploaded_file($_FILES['file']['tmp_name'])){
                    ...
                    if(!empty($csvData)){
                        foreach($csvData as $row){ $rowCount++;
                            ...
                            $prevCount = $this->amdmodelimport->getRows($con);///call the funtion at csvcodexmodel
                            ...
                            //         // 'income' => $row['Income'],
                                ...
                                $update = $this->amdmodelimport->update($memData, $condition);
                                ...
                                // Insert member data
                                $insert = $this->amdmodelimport->insert($memData);
