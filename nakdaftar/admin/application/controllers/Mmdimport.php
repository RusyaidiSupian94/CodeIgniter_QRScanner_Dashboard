...
class Mmdimport extends MY_Controller {
    
    function __construct() {
        parent::__construct();
        
        // Load member model
        $this->load->model('mmdmodelimport');
    ...
    public function index(){///to show dataset or datatable
        ...
        // Get rows
        $data['mmd'] = $this->mmdmodelimport->getRows();///dalam data tu table database
        ...
        $this->account();
        $this->load->view('importdata/mastery/mmd/mmddropdashboard');
        $this->load->view('importdata/mastery/mmd/mmddropexcel',$data);
                ...
                if(is_uploaded_file($_FILES['file']['tmp_name'])){
                    ...
                    if(!empty($csvData)){
                        foreach($csvData as $row){ $rowCount++;
                            ...
                            $prevCount = $this->mmdmodelimport->getRows($con);///call the funtion at csvcodexmodel
                            ...
                            //         // 'income' => $row['Income'],
                                ...
                                $update = $this->mmdmodelimport->update($memData, $condition);
                                ...
                                // Insert member data
                                $insert = $this->mmdmodelimport->insert($memData);
