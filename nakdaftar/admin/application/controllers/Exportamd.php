...
class Exportamd extends MY_Controller {
    // construct
    public function __construct() {
        parent::__construct();
        // load model
        $this->load->model('Export_modelamd', 'export');
    }    
    ...
    public function generateXlsx() {
        ...
        ////////////////////////////////////xlsx////////////////
        $filename = "AMD Excel2007 ". date("Y-m-d").".xlsx";
    ...
    public function generateXls() {
        ...
        ///////////////////////////xls//////
        $filename = "AMD Excel2005 ". date("Y-m-d").".xls";
    ...
    public function generateCsv() {
        ...
        //////////////////////csv////////////////////
        $filename = "AMD CSV ". date("Y-m-d").".csv";///////this for name file and date
        header('Content-Type: application/vnd.ms-excel'); 
        header('Content-Disposition: attachment;filename="'.$filename.'"');
        header('Cache-Control: max-age=0'); 
