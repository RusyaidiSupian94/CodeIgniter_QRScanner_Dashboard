...
class Updatedammd extends MY_Controller {
    ...
    public function view($id){
        ...
        if(!empty($id)){
            $data['updatedatammd'] = $this->updatedatammd->getRows(array('id' => $id));;///in the data bracket there are model there
            ...
            $this->load->view('crudsystem/mmdaddcust/view', $data);
    ...
    public function edit($id){
        ...
        // Get member data
        $memData = $this->updatedatammd->getRows(array('id' => $id));
        ...
        if($this->input->post('memSubmit')){
            ...
            //     // Update member data
            //     $update = $this->updatedatammd->update($memData, $id);
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/mmdaddcust/dashboardupdate');
        $this->load->view('crudsystem/mmdaddcust/add-edit',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function add(){
        ...
        if($this->input->post('memSubmit')){
            ...
            $config['imagedir']     = '../assets3/images/qrcode/mmd/'; //direktori penyimpanan qr code
            ...
            if($this->form_validation->run() == true){
                // Insert member data
                $insert = $this->updatedatammd->insert($memData);
       ...
       $data['updatedatammd'] = $memData;
        ...
        $this->load->view('sidebar');
        $this->account();
        $this->load->view('crudsystem/mmdaddcust/dashboardadd');
        $this->load->view('crudsystem/mmdaddcust/addcust',$data);
        $this->load->view('footer');
        $this->load->view('jsfooter');
    }
    ...
    public function delete($id){
        ...
        if($id){
            ...
            $delete = $this->updatedatammd->delete($id);
...
//////////////////////////////checking same data/////////////
    public function nric_check($str){
        ...
        $checkNric = $this->updatedatammd->getRows2($con);
        if($checkNric > 0){
    ...
    public function no_siri_check($str){
        ...
        $checkNo_siri = $this->updatedatammd->getRows2($con);
        if($checkNo_siri > 0){
